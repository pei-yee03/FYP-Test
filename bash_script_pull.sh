...
# "s" tells script to hide progress meter and most output. Silent mode
# "S" tells script to print errors if something goes wrong. Show errors
# "L" tells scripts to follow redirects, because some URLs don't serve the files directly. 